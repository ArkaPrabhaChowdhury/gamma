              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">India : +(91)63782-11571</p>
                    <p className="text-base text-body-color">USA : +1(914)425-5825</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 hidden md:flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <a href="https://gammainnovations.zohobookings.in/#/customer/203853000000034018?booknow=true" className="text-base text-body-color">
                     <b style="color:blue;"> Click here to schedule a call </b>
                    </a>
                  </div>
                </div>
              </div>
