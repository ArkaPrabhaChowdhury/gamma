...
const Contact = () => {
  return (
    <>
      <section
        className="bg-stone-100 py-20 px-12 lg:px-24 lg:py-[120px] overflow-hidden relative z-10"
        id="contact"
      >
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                ...
                />
                <div>
                  <button className="w-full p-3 text-white transition border rounded border-primary bg-[#006b9f] hover:bg-opacity-90">
                    Send Message
                  </button>
                </div>
